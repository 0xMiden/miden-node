...
pub struct SubmitNetworkNotes {
    /// Id of the transaction that created the notes.
    #[prost(message, optional, tag = "1")]
    pub transaction_id: ::core::option::Option<super::primitives::Digest>,
    /// The network notes to submit.
    #[prost(message, repeated, tag = "2")]
    pub note: ::prost::alloc::vec::Vec<super::account::NetworkNote>,
}
...
pub struct UpdateTransactionStatus {
    ...
    pub updates: ::prost::alloc::vec::Vec<update_transaction_status::TransactionUpdate>,
}
/// Nested message and enum types in `UpdateTransactionStatus`.
pub mod update_transaction_status {
    ...
    pub struct TransactionUpdate {
        ...
        #[prost(message, optional, tag = "1")]
        pub transaction_id: ::core::option::Option<super::super::primitives::Digest>,
        /// New status of the transaction.
        #[prost(enumeration = "super::super::blockchain::TransactionStatus", tag = "2")]
        pub status: i32,
    }
}
/// Update the status of network notes that were consumed externally.
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct UpdateNetworkNotes {
...
pub mod api_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn submit_network_notes(
            &mut self,
            request: impl tonic::IntoRequest<super::SubmitNetworkNotes>,
        ...
        pub async fn update_transaction_status(
            &mut self,
            request: impl tonic::IntoRequest<super::UpdateTransactionStatus>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status> {
            self.inner
                .ready()
                .await
        ...
        pub async fn update_network_notes(
            &mut self,
            request: impl tonic::IntoRequest<super::UpdateNetworkNotes>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status> {
            self.inner
                .ready()
                .await
...
pub mod api_server {
    ...
    pub trait Api: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn submit_network_notes(
            &self,
            request: tonic::Request<super::SubmitNetworkNotes>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
        /// Update network transaction builder with transaction status changes.
        ///
        /// Any transaction that has been either committed or reverted is communicated to the NTB so
        ...
        async fn update_transaction_status(
            &self,
            request: tonic::Request<super::UpdateTransactionStatus>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
        /// Update the status of network notes that were consumed externally.
        ///
        /// When a new transaction enters the mempool, the NTB needs to be notified of the nullifiers
        ...
        async fn update_network_notes(
            &self,
            request: tonic::Request<super::UpdateNetworkNotes>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
    }
    #[derive(Debug)]
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/ntx_builder.Api/SubmitNetworkNotes" => {
                    ...
                    impl<T: Api> tonic::server::UnaryService<super::SubmitNetworkNotes>
                ...
                "/ntx_builder.Api/UpdateTransactionStatus" => {
                    ...
                    impl<
                        T: Api,
                    > tonic::server::UnaryService<super::UpdateTransactionStatus>
                ...
                "/ntx_builder.Api/UpdateNetworkNotes" => {
                    ...
                    impl<T: Api> tonic::server::UnaryService<super::UpdateNetworkNotes>
