...
use miden_protocol::transaction::{AccountInputs, OutputNote, PartialBlockchain};
...
impl State {
    ...
    /// Returns account inputs for the specified account ID and reference block.
    pub async fn get_account_inputs(
        &self,
        account_id: AccountId,
        ref_block: BlockNumber,
    ) -> Result<AccountInputs, DatabaseError> {
