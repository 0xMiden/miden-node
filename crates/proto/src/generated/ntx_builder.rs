...
pub struct TransactionNetworkNotes {
...
pub struct TransactionStatus {
    ...
    pub updates: ::prost::alloc::vec::Vec<transaction_status::TransactionUpdate>,
}
...
pub mod api_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn submit_network_notes(
            &mut self,
            request: impl tonic::IntoRequest<super::TransactionNetworkNotes>,
        ...
        pub async fn update_transaction_status(
            &mut self,
            request: impl tonic::IntoRequest<super::TransactionStatus>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status> {
            self.inner
                .ready()
                .await
        ...
        pub async fn update_network_notes(
            &mut self,
            request: impl tonic::IntoRequest<super::NetworkNotes>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status> {
            self.inner
                .ready()
                .await
...
pub mod api_server {
    ...
    pub trait Api: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn submit_network_notes(
            &self,
            request: tonic::Request<super::TransactionNetworkNotes>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
        /// Update network transaction builder with transaction status changes.
        ///
        /// Any transaction that has been either committed or reverted is communicated to the NTB so
        ...
        async fn update_transaction_status(
            &self,
            request: tonic::Request<super::TransactionStatus>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
        /// Update the status of network notes that were consumed externally.
        ///
        /// When a new transaction enters the mempool, the NTB needs to be notified of the nullifiers
        ...
        async fn update_network_notes(
            &self,
            request: tonic::Request<super::NetworkNotes>,
        ) -> std::result::Result<tonic::Response<()>, tonic::Status>;
    }
    #[derive(Debug)]
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/ntx_builder.Api/SubmitNetworkNotes" => {
                    ...
                    impl<
                        T: Api,
                    > tonic::server::UnaryService<super::TransactionNetworkNotes>
                ...
                "/ntx_builder.Api/UpdateTransactionStatus" => {
                    ...
                    impl<T: Api> tonic::server::UnaryService<super::TransactionStatus>
                ...
                "/ntx_builder.Api/UpdateNetworkNotes" => {
                    ...
                    impl<T: Api> tonic::server::UnaryService<super::NetworkNotes>
