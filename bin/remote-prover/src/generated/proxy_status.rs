...
pub struct ProxyStatusResponse {
    ...
    #[prost(enumeration = "super::remote_prover::ProofType", tag = "2")]
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/proxy_status.ProxyStatusApi/Status",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("proxy_status.ProxyStatusApi", "Status"));
...
pub mod proxy_status_api_server {
    ...
    pub trait ProxyStatusApi: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn status(
            &self,
            request: tonic::Request<super::ProxyStatusRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ProxyStatusResponse>,
            tonic::Status,
        >;
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/proxy_status.ProxyStatusApi/Status" => {
                    ...
                    impl<
                        T: ProxyStatusApi,
                    > tonic::server::UnaryService<super::ProxyStatusRequest>
                    for StatusSvc<T> {
                        type Response = super::ProxyStatusResponse;
    ...
    pub const SERVICE_NAME: &str = "proxy_status.ProxyStatusApi";
