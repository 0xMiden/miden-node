...
use crate::COMPONENT;
use crate::generated::server::api_server::Api as ProverApi;
...
impl ProverRpcApi {
    ...
    pub async fn prove_tx(
        ...
        Ok(Response::new(proto::Proof { payload: proof.to_bytes() }))
    }
    ...
    pub fn prove_batch(
        ...
        Ok(Response::new(proto::Proof { payload: proven_batch.to_bytes() }))
    }
    ...
    pub fn prove_block(
        ...
        Ok(Response::new(proto::Proof { payload: proven_block.to_bytes() }))
    }
}
...
mod test {
    ...
    async fn test_prove_transaction() {
        ...
        let request_1 = Request::new(proto::ProofRequest {
            proof_type: proto::ProofType::Transaction.into(),
            payload: transaction_witness.to_bytes(),
        });

        let request_2 = Request::new(proto::ProofRequest {
            proof_type: proto::ProofType::Transaction.into(),
            payload: transaction_witness.to_bytes(),
        });
