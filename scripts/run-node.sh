...
VALIDATOR_INSECURE_STORAGE_KEY_DIRECTORY="scripts/testdata/insecure-golden-storage-key"
...
VALIDATOR_INSECURE_STORAGE_KEY_SECRET_SHARE="${VALIDATOR_INSECURE_STORAGE_KEY_DIRECTORY}/secret-share.wire"
