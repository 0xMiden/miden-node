...
pub struct BlockCommitted {
    ...
    #[prost(message, repeated, tag = "2")]
    pub transactions: ::prost::alloc::vec::Vec<super::transaction::TransactionId>,
}
/// A set of transactions was reverted and dropped from the mempool.
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct TransactionsReverted {
    #[prost(message, repeated, tag = "1")]
    pub reverted: ::prost::alloc::vec::Vec<super::transaction::TransactionId>,
}
...
pub mod api_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/block_producer.Api/MempoolEvents",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("block_producer.Api", "MempoolEvents"));
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/block_producer.Api/MempoolEvents" => {
                    #[allow(non_camel_case_types)]
                    struct MempoolEventsSvc<T: Api>(pub Arc<T>);
                    impl<T: Api> tonic::server::ServerStreamingService<()>
                    for MempoolEventsSvc<T> {
                        ...
                        fn call(&mut self, request: tonic::Request<()>) -> Self::Future {
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Api>::mempool_events(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
