...
use crate::COMPONENT;
use crate::generated::server::ProxyWorkerStatus;
use crate::generated::server::worker_status_api_client::WorkerStatusApiClient;
use crate::server::api::ProofType;
...
impl Worker {
    ...
    pub async fn check_status(&mut self, supported_proof_type: ProofType) -> Result<(), String> {
        ...
        let worker_supported_proof_type =
            match crate::generated::server::ProofType::try_from(worker_status.supported_proof_type)
            {
        ...
        if supported_proof_type != worker_supported_proof_type.into() {
...
impl From<&Worker> for ProxyWorkerStatus {
    fn from(worker: &Worker) -> Self {
        use crate::generated::server::WorkerHealthStatus as ProtoWorkerHealthStatus;
        Self {
