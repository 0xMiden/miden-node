...
pub mod api_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn prove(
            &mut self,
            request: impl tonic::IntoRequest<super::Prove>,
...
pub mod proxy_status_api_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn status(
            &mut self,
            request: impl tonic::IntoRequest<super::GetProxyStatus>,
...
pub mod worker_status_api_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn status(
            &mut self,
            request: impl tonic::IntoRequest<super::GetWorkerStatus>,
...
pub mod api_server {
    ...
    pub trait Api: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn prove(
            &self,
            request: tonic::Request<super::Prove>,
        ) -> std::result::Result<tonic::Response<super::Proof>, tonic::Status>;
    }
    #[derive(Debug)]
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/remote_prover.Api/Prove" => {
                    ...
                    impl<T: Api> tonic::server::UnaryService<super::Prove>
                    for ProveSvc<T> {
...
pub mod proxy_status_api_server {
    ...
    pub trait ProxyStatusApi: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn status(
            &self,
            request: tonic::Request<super::GetProxyStatus>,
        ) -> std::result::Result<tonic::Response<super::ProxyStatus>, tonic::Status>;
    }
    #[derive(Debug)]
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/remote_prover.ProxyStatusApi/Status" => {
                    ...
                    impl<
                        T: ProxyStatusApi,
                    > tonic::server::UnaryService<super::GetProxyStatus>
                    for StatusSvc<T> {
...
pub mod worker_status_api_server {
    ...
    pub trait WorkerStatusApi: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn status(
            &self,
            request: tonic::Request<super::GetWorkerStatus>,
        ) -> std::result::Result<tonic::Response<super::WorkerStatus>, tonic::Status>;
    }
    #[derive(Debug)]
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/remote_prover.WorkerStatusApi/Status" => {
                    ...
                    impl<
                        T: WorkerStatusApi,
                    > tonic::server::UnaryService<super::GetWorkerStatus>
                    for StatusSvc<T> {
