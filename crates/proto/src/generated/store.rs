...
pub mod api_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        /// TODO
        pub async fn get_current_mmr_peaks(
            &mut self,
            request: impl tonic::IntoRequest<
                super::super::requests::GetCurrentMmrPeaksRequest,
            >,
        ) -> std::result::Result<
            tonic::Response<super::super::responses::GetCurrentMmrPeaksResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic::codec::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/store.Api/GetCurrentMmrPeaks",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("store.Api", "GetCurrentMmrPeaks"));
            self.inner.unary(req, path, codec).await
        }
...
pub mod api_server {
    ...
    pub trait Api: std::marker::Send + std::marker::Sync + 'static {
        ...
        async fn get_current_mmr_peaks(
            &self,
            request: tonic::Request<super::super::requests::GetCurrentMmrPeaksRequest>,
        ) -> std::result::Result<
            tonic::Response<super::super::responses::GetCurrentMmrPeaksResponse>,
            tonic::Status,
        >;
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/store.Api/GetCurrentMmrPeaks" => {
                    #[allow(non_camel_case_types)]
                    struct GetCurrentMmrPeaksSvc<T: Api>(pub Arc<T>);
                    impl<
                        T: Api,
                    > tonic::server::UnaryService<
                        super::super::requests::GetCurrentMmrPeaksRequest,
                    > for GetCurrentMmrPeaksSvc<T> {
                        type Response = super::super::responses::GetCurrentMmrPeaksResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as Api>::get_current_mmr_peaks(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = GetCurrentMmrPeaksSvc(inner);
                        let codec = tonic::codec::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
