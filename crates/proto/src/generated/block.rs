...
pub struct BlockHeader {
    ...
    pub prev_block_commitment: ::core::option::Option<super::word::Word>,
    ...
    pub chain_commitment: ::core::option::Option<super::word::Word>,
    /// A commitment to account database.
    #[prost(message, optional, tag = "5")]
    pub account_root: ::core::option::Option<super::word::Word>,
    /// A commitment to the nullifier database.
    #[prost(message, optional, tag = "6")]
    pub nullifier_root: ::core::option::Option<super::word::Word>,
    /// A commitment to all notes created in the current block.
    #[prost(message, optional, tag = "7")]
    pub note_root: ::core::option::Option<super::word::Word>,
    /// A commitment to a set of IDs of transactions which affected accounts in this block.
    #[prost(message, optional, tag = "8")]
    pub tx_commitment: ::core::option::Option<super::word::Word>,
    /// A commitment to a STARK proof attesting to the correct state transition.
    #[prost(message, optional, tag = "9")]
    pub proof_commitment: ::core::option::Option<super::word::Word>,
    /// A commitment to all transaction kernels supported by this block.
    #[prost(message, optional, tag = "10")]
    pub tx_kernel_commitment: ::core::option::Option<super::word::Word>,
