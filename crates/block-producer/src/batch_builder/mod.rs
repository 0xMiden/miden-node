...
///
/// Transaction sets are pulled from the mempool at a configurable interval, and passed to a pool of
/// provers for proof generation. Proving is currently unimplemented and is instead simulated via
