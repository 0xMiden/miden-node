...
impl TryFrom<proto::rpc_store::AccountRequest> for AccountRequest {
    type Error = ConversionError;

    fn try_from(value: proto::rpc_store::AccountRequest) -> Result<Self, Self::Error> {
        let proto::rpc_store::AccountRequest { account_id, block_num, details } = value;

        let account_id = account_id
            .ok_or(proto::rpc_store::AccountRequest::missing_field(stringify!(account_id)))?
            .try_into()?;
...
impl TryFrom<proto::rpc_store::account_request::AccountDetailRequest> for AccountDetailRequest {
    type Error = ConversionError;

    fn try_from(
        value: proto::rpc_store::account_request::AccountDetailRequest,
    ) -> Result<Self, Self::Error> {
        let proto::rpc_store::account_request::AccountDetailRequest {
            code_commitment,
...
impl TryFrom<proto::rpc_store::account_request::account_detail_request::StorageMapDetailRequest>
    for StorageMapRequest
{
    type Error = ConversionError;

    fn try_from(
        value: proto::rpc_store::account_request::account_detail_request::StorageMapDetailRequest,
    ) -> Result<Self, Self::Error> {
        let proto::rpc_store::account_request::account_detail_request::StorageMapDetailRequest {
            slot_index,
            slot_data,
        } = value;

        let slot_index = slot_index.try_into()?;
        let slot_data = slot_data.ok_or(proto::rpc_store::account_request::account_detail_request::StorageMapDetailRequest::missing_field(stringify!(slot_data)))?.try_into()?;
...
impl TryFrom<proto::rpc_store::account_request::account_detail_request::storage_map_detail_request::SlotData>
    for SlotData
{
    type Error = ConversionError;

    fn try_from(value: proto::rpc_store::account_request::account_detail_request::storage_map_detail_request::SlotData) -> Result<Self, Self::Error> {
        use proto::rpc_store::account_request::account_detail_request::storage_map_detail_request::SlotData as ProtoSlotData;
...
impl TryFrom<proto::rpc_store::AccountResponse> for AccountResponse {
    type Error = ConversionError;

    fn try_from(value: proto::rpc_store::AccountResponse) -> Result<Self, Self::Error> {
        let proto::rpc_store::AccountResponse { block_num, witness, details } = value;

        let block_num = block_num
            .ok_or(proto::rpc_store::AccountResponse::missing_field(stringify!(block_num)))?
            .into();

        let witness = witness
            .ok_or(proto::rpc_store::AccountResponse::missing_field(stringify!(witness)))?
            .try_into()?;
...
impl From<AccountResponse> for proto::rpc_store::AccountResponse {
...
impl TryFrom<proto::rpc_store::account_response::AccountDetails> for AccountDetails {
    type Error = ConversionError;

    fn try_from(
        value: proto::rpc_store::account_response::AccountDetails,
    ) -> Result<Self, Self::Error> {
...
impl From<AccountDetails> for proto::rpc_store::account_response::AccountDetails {
