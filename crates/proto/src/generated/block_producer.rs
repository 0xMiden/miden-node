...
pub mod mempool_event {
    ...
    pub enum Event {
        #[prost(message, tag = "1")]
        TransactionAdded(super::TransactionAdded),
        #[prost(message, tag = "2")]
        BlockCommitted(super::BlockCommitted),
        #[prost(message, tag = "3")]
        TransactionsReverted(super::TransactionsReverted),
    }
}
...
pub struct TransactionAdded {
    ...
    pub id: ::core::option::Option<super::blockchain::TransactionId>,
    ...
    pub network_notes: ::prost::alloc::vec::Vec<super::account::NetworkNote>,
...
pub struct BlockCommitted {
    ...
    #[prost(message, repeated, tag = "2")]
    pub transactions: ::prost::alloc::vec::Vec<super::blockchain::TransactionId>,
}
/// A set of transactions was reverted and dropped from the mempool.
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct TransactionsReverted {
    #[prost(message, repeated, tag = "1")]
    pub reverted: ::prost::alloc::vec::Vec<super::blockchain::TransactionId>,
}
...
pub mod api_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn status(
            ...
            tonic::Response<super::super::shared::BlockProducerStatus>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            match req.uri().path() {
                ...
                "/block_producer.Api/Status" => {
                    ...
                    impl<T: Api> tonic::server::UnaryService<()> for StatusSvc<T> {
                        type Response = super::super::shared::BlockProducerStatus;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
